...
//
//        return ResponseEntity.ok(userSocialLinkService.update(principal.id(), request)
//        );
//    }
//
//    @DeleteMapping("/{id}")
//    public ResponseEntity<DeleteUserSocialLinkResponse> delete(
//            @AuthenticationPrincipal UserPrincipal principal,
//            @PathVariable Long id
//    ) {
//
//        return ResponseEntity.ok(
//                userSocialLinkService.deleteById(
//                        principal.id(),
//                        id
//                )
//        );
