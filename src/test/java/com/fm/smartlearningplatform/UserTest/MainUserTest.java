...
//        // =========================
//
//        Skill skill1 = skillService.createSkill("Java" + System.currentTimeMillis());
//
//        Skill skill2 = skillService.createSkill("Spring" + System.currentTimeMillis());
//
...
//
//        assertNotNull(user.getUserSkills());
//
...
//
//        User user = userService.findById(id);
//        assertFalse(Hibernate.isInitialized(user.getUserSkills()));
//
//        user = userService.findUserWithSkill(id);
//        assertTrue(Hibernate.isInitialized(user.getUserSkills()));
//    }
//
...
//        assertTrue(Hibernate.isInitialized(user.getUserSkills()));
//
//        int skillSize = user.getUserSkills().size();
//
...
//        user.addSkill(skill);
//        userService.save(user);
//        assertEquals(skillSize + 1, userService.findUserWithSkill(id).getUserSkills().size());
//    }
//
